...
//string for where GetGitInfo will read.
/*static std::string OUTPUT_PREFIX =
 "/home/vmgray/workspace/HMolPol/Simulation_Analysis/commit_06d91f8";*/
static std::string OUTPUT_PREFIX =
    "/home/csimpson/workspace/HMolPol/Simulation_Analysis/commit_dbaceca/BeamE_2GeV/Phi-10to10";
//string for where the files will be saved to
static std::string OUTPUT_PREFIX_SCRIPT =
    "/home/csimpson/workspace/HMolPol/Simulation_Analysis/commit_dbaceca/BeamE_2GeV/Phi-10to10/Target_Z_Cut_Distribution_Symmetric_BW";

//HMolPol include - Must be here as it needs to know about OUTPUT_PREFIX
#include "ExtractInitalConditions.h"

void Z_Cut_Distribution_Symmetric(
                                  std::string filename,
...
void Plot_Dummy()
{
  for (int i = 0; i < NUM_PRIMARIES; i++)
  {
    ...
    h_WHOLE_LENGTH_XY_DUMMY[i]->Draw();
...
//    p_Whole_Length_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Whole_Length_Dummy->SaveAs(
        Form("%s/Whole_Target_XY_Distribution_BW_primary_%d.C",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    c_Whole_Length_Dummy->SaveAs(
        Form("%s/Whole_Target_XY_Distribution_BW_primary_%d.png",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    ...
    h_WHOLE_LENGTH_NAIVE_XY_DUMMY[i]->Draw();
...
//    p_Whole_Length_Naive_XY_Dummy->SetX2NDC(.91);
    ...
    c_Whole_Length_Naive_Dummy->SaveAs(
        Form("%s/Whole_Target_XY_Distribution_BW_Naive_primary_%d.C",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    c_Whole_Length_Naive_Dummy->SaveAs(
        Form("%s/Whole_Target_XY_Distribution_BW_Naive_primary_%d.png",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
...
//    p_Cell_Length_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Cell_Length_Dummy->SaveAs(
        Form("%s/Cell_Target_XY_Distribution_BW_primary_%d.C",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    c_Cell_Length_Dummy->SaveAs(
        Form("%s/Cell_Target_XY_Distribution_BW_primary_%d.png",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    ...
    h_CELL_LENGTH_NAIVE_XY_DUMMY[i]->Draw();
...
//    p_Cell_Length_Naive_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Cell_Length_Naive_Dummy->SaveAs(
        Form("%s/Cell_Target_XY_Distribution_BW_naive_primary_%d.C",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    c_Cell_Length_Naive_Dummy->SaveAs(
        Form("%s/Cell_Target_XY_Distribution_BW_naive_primary_%d.png",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
...
//    p_Gas_Length_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Gas_Length_Dummy->SaveAs(
        Form("%s/Gas_Target_XY_Distribution_BW_primary_%d.C",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    c_Gas_Length_Dummy->SaveAs(
        Form("%s/Gas_Target_XY_Distribution_BW_primary_%d.png",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    ...
    h_GAS_LENGTH_NAIVE_XY_DUMMY[i]->Draw();
...
//    p_Gas_Length_Naive_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Gas_Length_Naive_Dummy->SaveAs(
        Form("%s/Gas_Target_XY_Distribution_BW_naive_primary_%d.C",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
    c_Gas_Length_Naive_Dummy->SaveAs(
        Form("%s/Gas_Target_XY_Distribution_BW_naive_primary_%d.png",
             OUTPUT_PREFIX_SCRIPT.c_str(), i));
  }
}
