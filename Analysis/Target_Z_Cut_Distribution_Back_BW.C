...
//string for the where GetGitInfo will read.
...
static std::string OUTPUT_PREFIX_SCRIPT =
    "/home/csimpson/workspace/HMolPol/Simulation_Analysis/commit_dbaceca/BeamE_2GeV/Phi-10to10/Target_Z_Cut_Distribution_Back_BW";
...
/***********************************************************
 ...
 - h_BACK_LENGTH_XY_DUMMY: xy distribution for primaries scattered off from behind the magnetic field
 - h_BACK_LENGTH_NAIVE_XY_DUMMY: xy distribution for naive primaries scattered off from behind the magnetic field
 - h_VERY_BACK_LENGTH_XY_DUMMY: xy distribution for primaries scattered off from in front of the cell
 - h_VERY_BACK_LENGTH_NAIVE_XY_DUMMY: xy distribution for naive primaries scattered off from in front of the cell
...
void Plot_Dummy()
{
  for (int i = 0; i < NUM_PRIMARIES; i++)
  {
    ...
    h_VERY_BACK_LENGTH_XY_DUMMY[i]->Draw();
...
//    p_Very_Back_Length_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Very_Back_Length_Dummy->SaveAs(
        Form("%s/Behind_Cell_XY_Distribution_BW_primary_%d.C",
             OUTPUT_PREFIX.c_str(), i));
    c_Very_Back_Length_Dummy->SaveAs(
        Form("%s/Behind_Cell_Target_XY_Distribution_BW_primary_%d.png",
             OUTPUT_PREFIX.c_str(), i));
    ...
    h_VERY_BACK_LENGTH_NAIVE_XY_DUMMY[i]->Draw();
...
//    p_Very_Back_Length_Naive_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Very_Back_Length_Naive_Dummy->SaveAs(
        Form("%s/Behind_Cell_Target_XY_Distribution_BW_naive_primary_%d.C",
             OUTPUT_PREFIX.c_str(), i));
    c_Very_Back_Length_Naive_Dummy->SaveAs(
        Form("%s/Behind_Cell_Target_XY_Distribution_BW_naive_primary_%d.png",
             OUTPUT_PREFIX.c_str(), i));
...
//    p_Back_Length_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Back_Length_Dummy->SaveAs(
        Form("%s/Behind_Gas_XY_Distribution_BW_primary_%d.C",
             OUTPUT_PREFIX.c_str(), i));
    c_Back_Length_Dummy->SaveAs(
        Form("%s/Behind_Gas_XY_Distribution_BW_primary_%d.png",
             OUTPUT_PREFIX.c_str(), i));
    ...
    h_BACK_LENGTH_NAIVE_XY_DUMMY[i]->Draw();
...
//    p_Back_Length_Naive_XY_Dummy->SetX2NDC(0.91);
    ...
    c_Back_Length_Naive_Dummy->SaveAs(
        Form("%s/Behind_Gas_XY_Distribution_BW_naive_primary_%d.C",
             OUTPUT_PREFIX.c_str(), i));
    c_Back_Length_Naive_Dummy->SaveAs(
        Form("%s/Behind_Gas_XY_Distribution_BW_naive_primary_%d.png",
             OUTPUT_PREFIX.c_str(), i));
  }
}
