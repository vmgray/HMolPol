...
std::string SAVE_PREFIX[NUM_PRIMARIES] =
    { "/home/csimpson/workspace/HMolPol/Simulation_Analysis/commit_19095aa/PrimaryGenZ_20cm/Dummy_G4_LEAD_GLASS/200000_Events/1_mm_Z_Cut_XY_Dist_BW_Primary_0",
      "/home/csimpson/workspace/HMolPol/Simulation_Analysis/commit_19095aa/PrimaryGenZ_20cm/Dummy_G4_LEAD_GLASS/200000_Events/1_mm_Z_Cut_XY_Dist_BW_Primary_1",
      "/home/csimpson/workspace/HMolPol/Simulation_Analysis/commit_19095aa/PrimaryGenZ_20cm/Dummy_G4_LEAD_GLASS/200000_Events/1_mm_Z_Cut_XY_Dist_BW_Primary_2" };
...
void Plot_Dummy()
{
  for (int primary_ID = 0; primary_ID < NUM_PRIMARIES; primary_ID++)
  {
    for (int cut_position = 0; cut_position < NUM_CUTS; cut_position++)
    {
      ...
      h_FRONT_FIELD_XY_DIST_DUMMY[primary_ID][cut_position]->Draw();
      ...
      h_BACK_FIELD_XY_DIST_DUMMY[primary_ID][cut_position]->Draw();
